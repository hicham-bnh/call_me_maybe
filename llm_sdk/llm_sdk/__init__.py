...
class Small_LLM_Model:
    ...
    def encode(self, text: str) -> torch.Tensor:
        ...
        return torch.tensor(
            [ids], device=self._device, dtype=torch.long
            )
    ...
    def get_logits_from_input_ids(self, input_ids: list[int]) -> list[float]:
        """
        Given a list of input token ids,
        ...
        # Get logits for the last token in
        # the sequence for the batch (batch size 1)
